                ...
                <div class="communication__forms">                    
                    <div class="communication__wrapper">
                        <div class="create-recall">
                            ...
                            <form class="form-content form-content_create-recall">
                                <input type="text" name="name" class="form-content__name form-content_create-recall__name" placeholder="Имя">
                                <input type="text" name="surname"placeholder="Фамилия (не обязательно)" class="form-content__surname form-content_create-recall__surname">
                                <textarea name="recall" placeholder="Оставить отзыв..." class="form-content__recall form-content_create-recall__recall"></textarea>

                                <div class="create-recall__buttons create-recall-buttons">
                                    <button class="button button_clear" type="submit">Очистить</button>
...
<!--                 <div class="recalls">
    ...
    <!--Отзывы-->
    <script src="js/communication/htmlObjects.js"></script>
